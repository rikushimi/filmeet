 ...
 <div class="right">
        <div class="menu">
          ...
          @if (Auth::id() == $user->id)
              ...
              <li role="presentation" class="{{ Request::is('followers*') ? 'active' : '' }}"><a href="{{ route('users.followers', ['id' => $user->id]) }}">Recieved Requests<span class="badge">{{ $count_followers }}</span></a></li>
